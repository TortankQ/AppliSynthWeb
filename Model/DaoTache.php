...
class DaoTache{
    ...
    public function insertTache($DaoTache){
        //Requête d'insertion
        $requete1 = 'INSERT INTO tache (Intitule, Quantite, PrixHT) values(:t_Intitule,:t_Quantite,:t_PrixHT);';

        
        $req1 = $this->bdd->prepare($requete1);
        $req1->execute( array(
            't_Intitule' => $DaoTache->getDateFacture(),
            't_Quantite' => $DaoTache->getMontantHT(),
            't_PrixHT' => $DaoTache->getMontantTTC(),
